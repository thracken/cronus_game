...
var Acheivement, Currency, Equipment, Gun, StoryPage, StorySegment, Team, TeamAbility, TeamArmor, TeamEquipment, TeamMember, crystals, da_gun, first_launch, first_run, gold, segment1, segment1_pages, story001_0, story001_1, story001_2, story001_3, story001_4, story001_5, story001_6, story001_7, story001_8, xp, xp_tick,
...
TeamMember = (function() {
  function TeamMember(name, team_class) {
    ...
    this.dodge = function() {
      return (this.speed + this.dexterity) / 100;
    };
...
TeamAbility = (function() {
  function TeamAbility(name, energy_cost, upgrade_cost, cooldown, level_required) {
    this.name = name;
...
Gun = (function(superClass) {
  extend(Gun, superClass);

  function Gun(name) {
    this.name = name;
    this.damage = Gun.__super__.constructor.apply(this, arguments);
  }
