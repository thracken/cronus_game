...
var Currency, StoryPage, StorySegment, Team, TeamAbility, TeamArmor, TeamEquipment, TeamMember, crystals, first_launch, first_run, gold, segment1, segment1_pages, story001_0, story001_1, story001_2, story001_3, story001_4, story001_5, story001_6, story001_7, story001_8, xp, xp_tick;
...
TeamMember = (function() {
  function TeamMember(name, team_class) {
    ...
    this.level = 0;
    this.active = false;
    this.skill_points = new Currency("Skill Points", 0);
    this.equipment = [];
    this.armor = [];
    this.abilities = [];
    switch (team_class) {
    ...
    switch (this.main_stat) {
      ...
      case "energy":
        this.damage = function() {
          return this.energy * main_stat_multiplier;
        };
    }
  }
